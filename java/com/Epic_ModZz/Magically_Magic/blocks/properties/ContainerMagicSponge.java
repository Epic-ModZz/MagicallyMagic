...
public class ContainerMagicSponge extends Container{
	private final int numRows;
	private final TileEntityMagicSponge chestInventory;
	
	public ContainerMagicSponge(InventoryPlayer playerInv, TileEntityMagicSponge chestInventory,EntityPlayer player) {
	...
	public TileEntityMagicSponge getChestInventory() {
